...
public class EventNight {
    ...
    private static String [] namesOfEndex={"Alkol Tüketim","Genel Endex"};
    ...
    public void calculateEndorsement_and_Profit(HashMap<String,Double> unitSalesPrice,HashMap<String,Double>  unitCostPrice){
        ...
        //
        alcoholConsumption=(salesOfNight[4]+10*salesOfNight[0]+5*salesOfNight[1])/(double)(this.getNumberOfTotalPerson()*3);
        endex=((this.profit/this.endorsement)*this.getNumberOfTotalPerson()*Math.pow(alcoholConsumption,2))/300;

    }

    public static String[] getNamesOfEndex() {
        return namesOfEndex;
    }
